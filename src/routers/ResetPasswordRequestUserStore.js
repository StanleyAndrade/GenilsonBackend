...
const UserStore = require('../models/UserStoreModel'); // Certifique-se de ajustar o caminho para o modelo de usuário

const routerResetPasswordUserStore = express();
routerResetPasswordUserStore.use(express.json());

// Endpoint para solicitar redefinição de senha
routerResetPasswordUserStore.post('/userstore/request-reset-password', async (req, res) => {
    try {
...
routerResetPasswordUserStore.post('/userstore/first-access', async (req, res) => {
    try {
        const { email } = req.body;
        const user = await UserStore.findOne({ email });
...
routerResetPasswordUserStore.post('/userstore/reset-password/:token', async (req, res) => {
    try {
...
module.exports = routerResetPasswordUserStore